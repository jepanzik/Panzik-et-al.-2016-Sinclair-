...
## Determining Pole Positions

The pole positions will be determined using the site corrdinates and magnetic directions measured from the sample.

The process uses the laws of sine and cosine on a sphere.